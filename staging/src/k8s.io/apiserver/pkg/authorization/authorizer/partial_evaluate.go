...
func evaluateConditions(conditions iter.Seq[Condition], evalCond func(cond Condition) PartialConditionEvaluationResult, effect, appliedDescription string) ([]string, []error, []Condition) {
	errs := []error{}
