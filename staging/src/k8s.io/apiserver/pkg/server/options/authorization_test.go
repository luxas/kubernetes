...
// owned by each authorizer implementation (privilegedGroupAuthorizer → "authorizer.k8s.io/PrivilegedGroups",
// path.NewAuthorizer → AuthorizerFunc → "authorizer.k8s.io/AuthorizerFunc",
// webhook from DelegatingAuthorizerConfig.New → "authorizer.k8s.io/Webhook").
func TestDelegatingAuthorizationOptionsToAuthorizerAuthorizerName(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			options:  &DelegatingAuthorizationOptions{},
			wantName: "authorizer.k8s.io/Union[]",
		},
		{
			...
			wantName: "authorizer.k8s.io/Union[authorizer.k8s.io/PrivilegedGroups]",
		},
		{
			...
			wantName: "authorizer.k8s.io/Union[authorizer.k8s.io/AuthorizerFunc]",
		},
		{
			...
			wantName: "authorizer.k8s.io/Union[authorizer.k8s.io/PrivilegedGroups, authorizer.k8s.io/AuthorizerFunc]",
		},
		{
			...
			useFakeClient: true,
			wantName:      "authorizer.k8s.io/Union[authorizer.k8s.io/PrivilegedGroups, authorizer.k8s.io/AuthorizerFunc, authorizer.k8s.io/Webhook]",
		},
		{
			...
			useFakeClient: true,
			wantName:      "authorizer.k8s.io/Union[authorizer.k8s.io/Webhook]",
		},
		{
