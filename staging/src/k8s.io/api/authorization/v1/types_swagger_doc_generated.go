...
var map_ConditionalAuthorizationOptions = map[string]string{
	...
	"encodingPreference": "encodingPreference specifies how the client would prefer the authorizer to encode the conditions. If unset, this field is defaulted to ConditionsEncodingPreferenceOptimized.",
}
