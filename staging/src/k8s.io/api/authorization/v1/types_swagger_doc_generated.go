...
var map_ConditionsAwareDecision = map[string]string{
	...
	"reason":          "reason is optional. It indicates why a request was allowed or denied. Ignored when type == ConditionsAwareDecisionTypeUnion or ConditionsAwareDecisionTypeConditionsMap.",
