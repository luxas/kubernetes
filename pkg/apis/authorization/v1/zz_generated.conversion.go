...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*authorizationv1.ConditionalAuthorizationOptions)(nil), (*authorization.ConditionalAuthorizationOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ConditionalAuthorizationOptions_To_authorization_ConditionalAuthorizationOptions(a.(*authorizationv1.ConditionalAuthorizationOptions), b.(*authorization.ConditionalAuthorizationOptions), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*authorization.ConditionalAuthorizationOptions)(nil), (*authorizationv1.ConditionalAuthorizationOptions)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_authorization_ConditionalAuthorizationOptions_To_v1_ConditionalAuthorizationOptions(a.(*authorization.ConditionalAuthorizationOptions), b.(*authorizationv1.ConditionalAuthorizationOptions), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_authorization_Condition_To_v1_Condition(in *authorization.Condition, out *authorizationv1.Condition, s conversion.Scope) error {
	out.ID = in.ID
	out.Effect = authorizationv1.ConditionEffect(in.Effect)
	out.Condition = in.Condition
	out.Description = in.Description
	return nil
}
...
func autoConvert_v1_ConditionalAuthorizationOptions_To_authorization_ConditionalAuthorizationOptions(in *authorizationv1.ConditionalAuthorizationOptions, out *authorization.ConditionalAuthorizationOptions, s conversion.Scope) error {
	out.EncodingPreference = authorization.ConditionsEncodingPreference(in.EncodingPreference)
	return nil
}

// Convert_v1_ConditionalAuthorizationOptions_To_authorization_ConditionalAuthorizationOptions is an autogenerated conversion function.
func Convert_v1_ConditionalAuthorizationOptions_To_authorization_ConditionalAuthorizationOptions(in *authorizationv1.ConditionalAuthorizationOptions, out *authorization.ConditionalAuthorizationOptions, s conversion.Scope) error {
	return autoConvert_v1_ConditionalAuthorizationOptions_To_authorization_ConditionalAuthorizationOptions(in, out, s)
}

func autoConvert_authorization_ConditionalAuthorizationOptions_To_v1_ConditionalAuthorizationOptions(in *authorization.ConditionalAuthorizationOptions, out *authorizationv1.ConditionalAuthorizationOptions, s conversion.Scope) error {
	out.EncodingPreference = authorizationv1.ConditionsEncodingPreference(in.EncodingPreference)
	return nil
}

// Convert_authorization_ConditionalAuthorizationOptions_To_v1_ConditionalAuthorizationOptions is an autogenerated conversion function.
func Convert_authorization_ConditionalAuthorizationOptions_To_v1_ConditionalAuthorizationOptions(in *authorization.ConditionalAuthorizationOptions, out *authorizationv1.ConditionalAuthorizationOptions, s conversion.Scope) error {
	return autoConvert_authorization_ConditionalAuthorizationOptions_To_v1_ConditionalAuthorizationOptions(in, out, s)
}
...
func autoConvert_authorization_ConditionsAwareDecision_To_v1_ConditionsAwareDecision(in *authorization.ConditionsAwareDecision, out *authorizationv1.ConditionsAwareDecision, s conversion.Scope) error {
	...
	out.Union = *(*[]authorizationv1.ConditionsAwareDecision)(unsafe.Pointer(&in.Union))
	return nil
}
...
func autoConvert_authorization_ConditionsMap_To_v1_ConditionsMap(in *authorization.ConditionsMap, out *authorizationv1.ConditionsMap, s conversion.Scope) error {
	out.ConditionsTarget = authorizationv1.ConditionsTarget(in.ConditionsTarget)
	out.ConditionsType = in.ConditionsType
	out.Conditions = *(*[]authorizationv1.Condition)(unsafe.Pointer(&in.Conditions))
	return nil
}
...
func autoConvert_authorization_SelfSubjectAccessReviewSpec_To_v1_SelfSubjectAccessReviewSpec(in *authorization.SelfSubjectAccessReviewSpec, out *authorizationv1.SelfSubjectAccessReviewSpec, s conversion.Scope) error {
	...
	out.ConditionalAuthorization = (*authorizationv1.ConditionalAuthorizationOptions)(unsafe.Pointer(in.ConditionalAuthorization))
	return nil
}
...
func autoConvert_authorization_SubjectAccessReviewStatus_To_v1_SubjectAccessReviewStatus(in *authorization.SubjectAccessReviewStatus, out *authorizationv1.SubjectAccessReviewStatus, s conversion.Scope) error {
	...
	out.Reason = in.Reason
	out.EvaluationError = in.EvaluationError
	out.ConditionalDecision = (*authorizationv1.ConditionsAwareDecision)(unsafe.Pointer(in.ConditionalDecision))
	return nil
}
