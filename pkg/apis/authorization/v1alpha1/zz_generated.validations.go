...
func Validate_AuthorizationConditionsRequest(
	...
	{ // field authorizationv1alpha1.AuthorizationConditionsRequest.Decision
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *authorizationv1alpha1.AuthorizationConditionsRequest) *v1.ConditionsAwareDecision {
...
func Validate_AuthorizationConditionsResponse(
	...
	{ // field authorizationv1alpha1.AuthorizationConditionsResponse.Decision
		...
		oldVal := safe.Field(oldObj,
			func(oldObj *authorizationv1alpha1.AuthorizationConditionsResponse) *v1.ConditionsAwareDecision {
				return &oldObj.Decision
			})
		errs = append(errs, fn(fldPath.Child("decision"), &obj.Decision, oldVal, oldObj != nil)...)
	}
