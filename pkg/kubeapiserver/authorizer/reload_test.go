...
`), 0o600); err != nil {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantName: "authorizer.k8s.io/Union[authorizer.k8s.io/PrivilegedGroups, alwaysallow]",
		},
		{
			name: "AlwaysDeny",
			entries: []authzconfig.AuthorizerConfiguration{
			...
			wantName: "authorizer.k8s.io/Union[authorizer.k8s.io/PrivilegedGroups, alwaysdeny]",
		},
		{
			name: "Node",
			entries: []authzconfig.AuthorizerConfiguration{
			...
			wantName: "authorizer.k8s.io/Union[authorizer.k8s.io/PrivilegedGroups, node]",
		},
		{
			name: "RBAC",
			entries: []authzconfig.AuthorizerConfiguration{
			...
			wantName: "authorizer.k8s.io/Union[authorizer.k8s.io/PrivilegedGroups, rbac]",
		},
		{
			name: "ABAC",
			entries: []authzconfig.AuthorizerConfiguration{
			...
			wantName: "authorizer.k8s.io/Union[authorizer.k8s.io/PrivilegedGroups, abac]",
		},
		{
			...
			wantName: "authorizer.k8s.io/Union[authorizer.k8s.io/PrivilegedGroups, node, rbac, fallback-allow]",
		},
		{
			...
			wantName: "authorizer.k8s.io/Union[authorizer.k8s.io/PrivilegedGroups, node, rbac, webhook1, webhook2, fallback-deny]",
		},
	}
